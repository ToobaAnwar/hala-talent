              ...
              <div className="row">
                <div className="col-lg-4">
                 <NavLink to="/employerProfile" style={{textDecoration: "none"}}>
                    ...
                    <span className="promotepof-badge"><i className="fa fa-star" title="Featured"></i></span>
                ...
                <div className="col-lg-4">
                  <a href="candidate_profile.html" style={{textDecoration: "none"}}>
                    <div className="candidate-grid">
                    <img src={cand2} alt="" />
                    <h4>Lori Ramos</h4>
                ...
                <div className="col-lg-4">
                  <a href="candidate_profile.html" style={{textDecoration: "none"}}>
                    <div className="candidate-grid">
                    <img src={cand7} alt="" />
                    <span className="careerfy-candidate-grid-status" style={{backgroundColor: "#40d184"}}></span>
